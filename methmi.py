...
# Retrieve the documents from the collection, excluding "vine", "product_parent"
columns
...
# Group by review_date and calculate the mean star_rating
for each date
...
all_reviews_headline = " ".join(review_headline
  for review_headline in df['review_headline'])
...
all_reviews_body = " ".join(review_body
